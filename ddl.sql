...
VALUES ('Vanilla', 'White', 'Strawberry', 'Red', 5.00),
('Mint Oreo', 'Black', 'Peanut Butter', 'Brown', 10.00),
('Mocha', 'Brown', 'Red Velvet', 'Red', 15.00);
...
(SELECT workerID FROM Workers WHERE firstName = 'Skyler' AND lastName = 'Ucol'), '2024-01-30', '2024-02-07', 50.00),
((SELECT customerID FROM Customers WHERE firstName = 'Steven' AND lastName = 'Lee'), 
(SELECT workerID FROM Workers WHERE firstName = 'Kevin' AND lastName = 'Juanda'), '2023-12-04', '2021-12-11', 35.00),
((SELECT customerID FROM Customers WHERE firstName = 'John' AND lastName = 'Smith'), 
(SELECT workerID FROM Workers WHERE firstName = 'Jenny' AND lastName = 'Kim'), '2023-12-20', '2023-12-27', 45.00);
